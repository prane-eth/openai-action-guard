...
from openai._utils import assert_signatures_in_sync, consume_sync_iterator
...
@pytest.mark.respx(base_url=base_url)
def test_action_guard_blocks_streaming_tool_calls(client: OpenAI, respx_mock: MockRouter) -> None:
    seen: list[openai.AgentAction] = []
    ...
    respx_mock.post("/chat/completions").mock(
        return_value=httpx.Response(
            200,
            content=(
                b'data: {"id":"chatcmpl-stream-1","object":"chat.completion.chunk","created":1727346167,'
                b'"model":"gpt-5.4-2026-03-05","choices":[{"index":0,"delta":{"role":"assistant",'
                b'"tool_calls":[{"index":0,"id":"call_123","type":"function","function":'
                b'{"name":"get_weather","arguments":"{}"}}]},"finish_reason":null}]}'
                b"\n\n"
                b"data: [DONE]\n\n"
            ),
